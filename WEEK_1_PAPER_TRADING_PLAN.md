...
Decision date: Friday, March 13, 2026
...
For a selective setup:

- positive expectancy matters more than hit rate

For a factory-style setup:

- first-5-minute green rate must be strong enough to justify fast harvesting
...
2. Fix bugs and telemetry only.
3. Collect 3-5 clean sessions.
4. Review setup-level data on Friday.
5. Decide whether to:
   - narrow Velox into a selective alpha bot, or
   - build a separate factory mode for high-velocity profit harvesting.

Until then, treat every green day with skepticism and every clean trade with interest.
